...
public class TeamInfoState implements GameState {
	...
	public void Entered(GUIController root) throws FileNotFoundException {
		...
		scroll.setMinWidth(manager.getStage().getWidth());
		...
		Image picture1 = new Image("file:bildJan.jpg",imageSize,imageSize,true,true);
		v1.setImage(picture1);
		ImageView v2 = new ImageView();
		Image picture2 = new Image("file:bildJan.jpg",imageSize,imageSize,true,true);
		ImageView v3 = new ImageView();
		Image picture3 = new Image("file:bildJan.jpg",imageSize,imageSize,true,true);
		ImageView v4 = new ImageView();
		Image picture4 = new Image("file:bildJan.jpg",imageSize,imageSize,true,true);
		ImageView v5 = new ImageView();
		Image picture5 = new Image("file:bildJan.jpg",imageSize,imageSize,true,true);
